  ...
  return (
    <div className="flex flex-col items-center w-full mt-[40px]">
      ...
      <input
        ...
        className="w-full form-control py-1.5 px-3 text-base font-normal text-gray-300 bg-[#343434] bg-clip-padding border border-solid border-[#FB40FF] rounded-[20px] transition ease-in-out m-0 focus:text-gray-200 focus:bg-[#343434] focus:border-[#FB40FF] focus:outline-none"
