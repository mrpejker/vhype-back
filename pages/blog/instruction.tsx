...
const InstructionPage: NextPage = () => {
  return (
    <PageLayout title={'title'} pageName="Blog" category="Resources" description="">
      <div className="w-full h-[300px] bg-[url(/instrcover.png)] bg-no-repeat bg-center bg-cover rounded-[20px] max-w-[1240px] px-[20px]" />
      <section className="flex flex-col md:flex-row-reverse w-full max-w-[1240px] px-[20px] py-[40px] text-[#3D3D3D] items-start justify-between">
        <NavSideBar />
        <article className="flex flex-col md:basis-2/3">
          <h1 className="font-drukMedium text-[32px] text-black mb-[40px]">vSelf Instructions</h1>
          <div className="flex flex-col mb-[20px]" id="refferal">
            <h2 className="font-interBold text-[25px] text-black mb-[20px]">NFT reward</h2>
            <p>
              To claim the NFT reward, follow the{' '}
              <ActiveLink href="/claim/3368006310?strings=QR_ReFi_Course" className="underline hover:no-underline">
                <span>referral link</span>
              </ActiveLink>
              you have been provided. If you don&apos;t have an account follow the instruction below
            </p>
          </div>
          ...
          <div className="flex flex-col" id="refferal">
            <h2 className="font-interBold text-[25px] text-black mb-[20px]">NFT reward</h2>
            <p>
              To claim the NFT reward, follow the{' '}
              <ActiveLink href="/claim/3368006310?strings=QR_ReFi_Course" className="underline hover:no-underline">
              ...
              you have been provided. To see your NFT, sign in with your account at{' '}
              <ActiveLink href="https://mynearwallet.com/" className="underline hover:no-underline">
                <span>MyNearWallet</span>
              </ActiveLink>{' '}
              or{' '}
              <ActiveLink href="/vranda" className="underline hover:no-underline">
                <span>vRanda</span>
              </ActiveLink>
            </p>
          </div>
...
const NavSideBar: React.FC = () => (
  <aside className="flex w-full mb-[40px] flex-col md:basis-1/4 p-[40px] bg-[#ecebeb] rounded-[20px] md:sticky top-[100px]">
