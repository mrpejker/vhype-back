...
const ContactPage: NextPage = () => {
  return (
    <PageLayout title="vSelf Contacts" description="vSelf Contacts" pageName="About">
      <section className="flex w-full flex-col sm:flex-row max-w-[1240px] mx-auto mb-[40px] pt-[40px] px-[20px] font-inter mt-[140px]">
