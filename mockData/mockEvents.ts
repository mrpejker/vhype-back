...
export const mockEvent: CollectionData = {
  ...
  quests: [
    {
      qr_prefix: `${hash('https://vself-dev.web.app/vself.apk')}`,
    ...
    {
      qr_prefix: `${hash('You have registered in the NEAR community')}`,
    ...
    {
      qr_prefix: `${hash('Congrats! Now you know more about Web3')}`,
    ...
    {
      qr_prefix: `${hash('Thank you <3 and see you soon!')}`,
...
export const mockUserEvents: Collection[] = [
  [
    1887539744,
    {
      ...
      quests: [
        ...
        {
          qr_prefix: '82e35a63ceba37e9646434c5dd412ea577147f1e4a41ccde1614253187e3dbf9',
          qr_prefix_len: 7,
          reward_title: 'vSelf: Tester Badge',
          reward_description: 'Welcome to the test!',
  ...
  [
    906254051,
    {
      ...
      quests: [
        {
          qr_prefix: '77af778b51abd4a3c51c5ddd97204a9c3ae614ebccb75a606c3b6865aed6744e',
          qr_prefix_len: 3,
          reward_title: 'vSelf: Tester Badge',
        ...
        {
          qr_prefix: 'cd6357efdd966de8c0cb2f876cc89ec74ce35f0968e11743987084bd42fb8944',
          qr_prefix_len: 3,
          reward_title: 'vSelf: Tester Badge',
        ...
        {
          qr_prefix: '0ddf8cbefa6ed1a5d0c71ea559734bcd2c6261bd3ae34cfba7a007859cb366e5',
          qr_prefix_len: 6,
          reward_title: 'vSelf: Tester Badge',
  ...
  [
    1187296838,
    {
      ...
      quests: [
        {
          qr_prefix: 'fbbc17ca091ca1b8d393ca74da1a935fd0c488756f0a14f77fc8cf2b38e7c171',
          qr_prefix_len: 7,
        ...
        {
          qr_prefix: 'd7e3406a69679ff35268ba7458496528538eb64b5272ffda6b35b75b03b5abce',
          qr_prefix_len: 7,
...
export const mockBarcelonaEvent: CollectionData = {
  ...
  quests: [
    {
      qr_prefix: 'https://vself.app/ethbarcelona?1',
      qr_prefix_len: 0,
    ...
    {
      qr_prefix: 'https://vself.app/ethbarcelona?2',
      qr_prefix_len: 0,
    ...
    {
      qr_prefix: 'https://vself.app/ethbarcelona?3',
      qr_prefix_len: 0,
    ...
    {
      qr_prefix: 'https://vself.app/ethbarcelona?4',
      qr_prefix_len: 0,
